          ...
          <div class="container">
            <div class="section">
              ...
              <div id="table-datatables">
                <h4 class="header">Data Ketenagaan Rumah Sakit</h4>
                <div class="row">
                  <div class="col s12">
                    <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                       ...
                       <tbody>
                        ...
                        $query = "SELECT pegawai.nama_pegawai, ketenagaan_rs.id_ketenagaan, ketenagaan_rs.id_pegawai, ketenagaan_rs.nama_ketenagaan, ketenagaan_rs.jenis_ketenagaan, ketenagaan_rs.status, ketenagaan_rs.keterangan FROM ketenagaan_rs LEFT JOIN pegawai ON pegawai.id_pegawai = ketenagaan_rs.id_pegawai";
                        ...
                        <td><?php echo $data['nama_ketenagaan']; ?></td>  
                        <td><?php echo $data['jenis_ketenagaan']; ?></td> 
                        <td><?php echo $data['status']; ?></td>
                        <td><?php echo $data['keterangan']; ?></td>   
                        <td style="width:100px;text-align: center;">
                        <?php echo "
                        <a href='ketenagaan_form_ubah.php?id_ketenagaan=$data[id_ketenagaan]'>|Ubah|</a>
                        <a href='ketenagaan_proses_hapus.php?id_ketenagaan=$data[id_ketenagaan]' onclick=\"return confirm('Anda yakin akan menghapus data ?')\">|Hapus|</a>";
                        ?>
                        </td> 
                        </tr>         
                        <?php
