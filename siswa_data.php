          ...
          <div class="container">
            <div class="section">
              ...
              <div id="table-datatables">
                <h4 class="header">Data Dokter</h4>
                <div class="row">
                  <div class="col s12">
                    <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                       ...
                       <tbody>
                        ...
                        <tr>
                        <td><?php echo $no++; ?></td>
                        <td><?php echo $data['id_nis']; ?></td>  
                        <td><?php echo $data['nama']; ?></td> 
                        <td><?php echo $data['kelas']; ?></td>
                        <td><?php echo $data['jurusan']; ?></td>   
                        <td style="width:100px;text-align: center;">
                        <?php echo "
                        <a href='siswa_form_ubah.php?id_nis=$data[id_nis]'>|Ubah|</a>
                        <a href='siswa_proses_hapus.php?id_nis=$data[id_nis]' onclick=\"return confirm('Anda yakin akan menghapus data ?')\">|Hapus|</a>";
                        ?>
                        </td> 
                        </tr> 
                        <?php
