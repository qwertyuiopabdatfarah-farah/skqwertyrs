            ...
            <div class="row">
              <div class="col s12 m12 l12">
                <div class="card-panel">
                  <h4 class="header2">Form Ubah Data siswa</h4>
                  <div class="row">
                  <?php
                  include 'config/koneksiDB.php';
                  $id_nis    = $_GET['id_nis'];
                  $query       = "SELECT * FROM siswa WHERE id_nis='$id_nis'";
                 ...
                 ?> 
                    <form class="col s12" action="siswa_proses_ubah.php" method="POST">

                      <input type="hidden" name="id_nis" value="<?php echo $id_nis; ?>"/> 

                      <div class="row">

                        <div class="input-field col s6">
                          <input type="text" name="id_nis" required="required" value="<?php echo $id_nis; ?>">
                          <label for="nama">id_nis</label>
                        </div>
                        ...
                        <div class="input-field col s6">
                          <input type="text" name="jurusan" required="required" value="<?php echo $jurusan; ?>">
                        ...
                        <div class="row">
                          <div class="input-field col s12">
                            <button class="btn cyan waves-effect waves-light right" type="submit" name="ubah_siswa">Simpan
